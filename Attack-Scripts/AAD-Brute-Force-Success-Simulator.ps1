...
$username = "attacker@attacker.onmicrosoft.com" # Some Username that exists in your AAD Tenant
$correct_password = "AttackerPassword" # Enter the correct password for the above user
